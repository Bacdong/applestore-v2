<?php
    ...
    $query = "SELECT o.*, u.name FROM orders o LEFT JOIN users u ON o.user_id = u.id";
                ...
                <section class="main-product c-12 l-7 m-12">
                    ...
                    <table border="1" class="table-product">
                        <thead class="table-head">
                            ...
                            <th class="head-title img">Fullname</th>
                        ...
                        <tbody class="table-body">
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-column"><?=$bill['name'];?></td>
                                <td class="table-column"><?=$bill['created_at'];?></td>
                                <td class="table-column price"><?php echo '$'.$bill['totalPrice'];?></td>
                                <?php
                                    if ($bill['status'] == 0) {
                                        echo '<td class="table-column active" style="color: red">';
                                        echo 'Unconfirm';
                                    } else {
                                        echo '<td class="table-column active" style="color: blue">';
                                        echo 'Confirmed';
                                    }
                                ?>
                                </td>
