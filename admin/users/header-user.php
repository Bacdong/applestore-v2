<header class="header grid">
    <nav class="header-navbar grid wide">
        <div class="header-navbar-menu c-1">
            ...
            <nav class="navbar-menu-left">
                ...
                <ul class="menu-left__list">
                    ...
                    <li class="menu-left__item">
                        <a href="../products/admin.php" class="menu-left__item-link">
        ...
        <ul class="navbar-author__list">
            <li class="navbar-author__item item-name"><?php echo $_SESSION['admin']['surname'].' '.$_SESSION['admin']['name'];?></li>
            <li class="navbar-author__item item-signup"><a href="../logout_admin.php" class="auth-signup">Sign up</a></li>
        </ul>
    </nav>
</header>